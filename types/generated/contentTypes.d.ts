...
export interface ApiAuthorAuthor extends Schema.CollectionType {
  ...
  attributes: {
    ...
    title: Attribute.Enumeration<
      ['Sr. Chief Editor', 'Editor', 'Author', 'Founder']
    >;
...
export interface ApiJoinNewsletterJoinNewsletter extends Schema.CollectionType {
  ...
  info: {
    singularName: 'join-newsletter';
    pluralName: 'join-newsletters';
  ...
  attributes: {
    newsletter: Attribute.Enumeration<['email']>;
    email: Attribute.Email & Attribute.Required & Attribute.Unique;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::join-newsletter.join-newsletter',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiNewsCategoryNewsCategory extends Schema.CollectionType {
  ...
  attributes: {
    ...
    newsArticle: Attribute.Relation<
